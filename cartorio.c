	...
	int main()
		{
			...
			int comparacao; // int significa retorno q a função strcmp vai me dar casp seja zero, q sginifica array q é igual a "admin. Contudo, caso seja diferença -else- vai dar como senha inválida.
